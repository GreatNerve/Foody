      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
          <div className="mx-auto max-w-sm lg:max-w-none">
            <strong className="block text-center lg:text-left text-xl font-bold text-gray-900 sm:text-3xl dark:text-white">
              Foody
            </strong>
            <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg dark:text-gray-400">
              ...
              the best service. We have a wide range of options to choose from.
              We are sure you will find the perfect meal for you.
            </p>
